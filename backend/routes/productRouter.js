...
router
	...
	.post(
		...
		[
			...
			body('description').isString().withMessage('product description should be characters'),
			body('price').isNumeric().withMessage('product price should be numeric'),
			body('quantity').isNumeric().withMessage('product quantity should be numeric'),
			body('category').isMongoId().withMessage('product category should be mongo ID'),
			body('businessId').isMongoId().withMessage('product businessId should be mongo ID'),
		],
		validationMW,
	...
	.put(
		authMW,
		[
			body('id').notEmpty().isMongoId().withMessage('product id should be mongo id'),
			body('name').optional().isString().withMessage('product name should be characters'),
			body('description')
				.optional()
				.isString()
				.withMessage('product description should be characters'),
			body('price').optional().isNumeric().withMessage('product price should be numeric'),
			body('quantity')
				.optional()
				.isNumeric()
			...
			body('imageLink').optional().isString().withMessage('image link should be string'),
		],
		validationMW,
...
router
	.route('/products/:id')
	.get(
		[param('id').notEmpty().isMongoId().withMessage('Product id should be mongo id')],
		validationMW,
